...
<head>
    ...
    <title>Añadir cotización - Multi-Works Group</title>
...
<h2 class="display-6 text-center p-2 mt-5 header-cotiz" id="fuente2">Añadir cotización</h2>
<main class="container my-5 p-5">
    <form method="post" class="container px-5 form-cotiz">
        ...
        <div class="form-floating mb-3">
            <input type="date" class="form-control" name="inicio" id="inicio" placeholder="a">
            <label for="inicio">Fecha tentativa de inicio</label>
        </div>
        <div class="form-floating mb-3">
            <input type="date" class="form-control" name="fin" id="fin" placeholder="a">
            <label for="fin">Fecha tentativa de fin</label>
        </div>
        <div class="form-floating mb-3">
